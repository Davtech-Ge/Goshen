...
return (
    <section className='bg-black h-[80vh] text-white py-4 px-4 relative'>
        <h1 className='md:text-2xl text-lg'>Latest Feature</h1>
        <div className='w-full max-w-5xl h-[60vh] mt-20 mx-auto'>
            <AnimatePresence>
                <motion.div 
        ...
        <AnimatePresence>
        <div className='lg:absolute lg:top-1/4 lg:left-4 grid lg:grid-cols-1 grid-cols-3 gap-4 text-center mx-6'>
                <motion.button
                    whileHover={{ scale: 1.2}}
                    whileTap={{ scale: 0.8}}
                onClick={() => handleClick(1)} className='bg-gray-800 lg:py-4 py-2 lg:px-4 px-3 shadow-lg rounded'>
                ...
                <motion.button 
                    whileHover={{ scale: 1.2}}
                    whileTap={{ scale: 0.8}}
                onClick={() => handleClick(2)} className='bg-gray-800 lg:py-4 shadow-lg py-2 lg:px-4 px-3 rounded'>
                ...
                <motion.button 
                    whileHover={{ scale: 1.2}}
                    whileTap={{ scale: 0.8}}
                onClick={() => handleClick(3)} className='bg-gray-800 py-3 shadow-lg px-4 rounded'>
                    <div className='text-2xl mb-2'><span className='text-3xl opacity-75'>✉</span></div>
