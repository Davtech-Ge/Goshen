...
const BoxStyles = () => {
return (
    <section className='w-full min-h-screen flex bg-black mb-24'>
        <div className='w-full min-h-screen p-4 flex flex-col'>
            <div className='w-full'>
             <FirstFruit />
            </div>
            <div className='flex flex-row w-full'>
                <div className='w-1/3 h-[50vh] bg-blue-800 rounded-lg p-10 mx-5 my-5'>
                ...
                <div className='w-1/3 h-[54vh] bg-blue-800 rounded-lg p-10 mx-5 my-5'>
